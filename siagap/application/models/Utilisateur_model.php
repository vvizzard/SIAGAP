...
class Utilisateur_model extends CI_Model
{
	...
	public function add($nom, $email, $password) {
		if (sizeof($this->findGeneric(array('email' => $email )))>0) {
			return false;
		}
	...
	public function add2($nom, $password, $idAp) {
		if (sizeof($this->findGeneric(array('email' => $nom )))>0) {
			return false;
		}
    ...
    return $this->findGeneric(array('email' => $nom));
	}
